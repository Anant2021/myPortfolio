  ...
  return (
      ...
      <motion.div
        ...
        <motion.div
          ...
          initial="initial"
          animate='animate'
          id='t1' className='rounded-2xl border-4  border-neutral-800 p-4'>
        ...
        <motion.div
          ...
          initial="initial"
          animate='animate'
          id='spring' className='rounded-2xl border-4  border-neutral-800 p-4'>
              <SiSpringboot className='text-7xl text-400'/>
              </motion.div> 
